...
<script>
    ...
    export default {
        name: "draggable-header-template",
        data(){
            return {
                dragging: false,
                c: {
        ...
        methods: {
            startDrag(e){
                e=e.changedTouches?e.chagedTouches[0]:e;
                this.dragging=true;
                this.start.x=e.pageX;
                this.start.y=e.pageY;
            },
            onDrag(e){
                e=e.chagedTouches?e.chagedTouches[0]:e;
                if(this.dragging){
...
<style scoped>
    .draggable-header-view{
        ...
        margin: 30px auto;
        position: relative;
        font-family: 'Roboto', Helvetica, Arial, snas-serif;
        color: #fff;
        font-size: 14px;
        font-weight: 300;
